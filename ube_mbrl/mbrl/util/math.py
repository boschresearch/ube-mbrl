...
class Normalizer:
    ...
    def update_stats(self, data: ube_mbrl.mbrl.types.TensorType):
    ...
    def normalize(self, val: Union[float, ube_mbrl.mbrl.types.TensorType]) -> torch.Tensor:
    ...
    def denormalize(self, val: Union[float, ube_mbrl.mbrl.types.TensorType]) -> torch.Tensor:
