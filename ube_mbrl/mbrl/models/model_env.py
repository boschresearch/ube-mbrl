...
class ModelEnv:
    ...
    def __init__(
        ...
        env: gym.Env,
        model: Model,
        termination_fn: ube_mbrl.mbrl.types.TermFnType,
        reward_fn: Optional[ube_mbrl.mbrl.types.RewardFnType] = None,
    ...
    def reset(
        ...
        """
        if isinstance(self.dynamics_model, ube_mbrl.mbrl.models.OneDTransitionRewardModel):
    ...
    def step(
        self,
        actions: ube_mbrl.mbrl.types.TensorType,
        model_state: Dict[str, torch.Tensor],
        sample: bool = False,
    ) -> Tuple[ube_mbrl.mbrl.types.TensorType, ube_mbrl.mbrl.types.TensorType, np.ndarray, Dict]:
        ...
        with torch.no_grad():
            ...
            rewards = (
                ...
                else self.reward_fn(actions, obs)
            )
    ...
    def evaluate_action_sequences(
        ...
        with torch.no_grad():
            ...
            tiling_shape = (num_particles * population_size,) + tuple([1] * initial_state.ndim)
